...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/DE0_CV_QSYS_onchip_mem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_timer.v"                      -work timer                      -cdslib ./cds_libs/timer.cds.lib                     
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_sysid_qsys.v"                 -work sysid_qsys                 -cdslib ./cds_libs/sysid_qsys.cds.lib                
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_switches.v"                   -work switches                   -cdslib ./cds_libs/switches.cds.lib                  
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_seg7_digits.v"                -work seg7_digits                -cdslib ./cds_libs/seg7_digits.cds.lib               
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_sdram.v"                      -work sdram                      -cdslib ./cds_libs/sdram.cds.lib                     
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_sdram_test_component.v"       -work sdram                      -cdslib ./cds_libs/sdram.cds.lib                     
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_pll.vo"                       -work pll                        -cdslib ./cds_libs/pll.cds.lib                       
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_onchip_mem.v"                 -work onchip_mem                 -cdslib ./cds_libs/onchip_mem.cds.lib                
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_nios2_qsys.v"                 -work nios2_qsys                 -cdslib ./cds_libs/nios2_qsys.cds.lib                
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_leds.v"                       -work leds                       -cdslib ./cds_libs/leds.cds.lib                      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_keys.v"                       -work keys                       -cdslib ./cds_libs/keys.cds.lib                      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/DE0_CV_QSYS_jtag_uart.v"                  -work jtag_uart                  -cdslib ./cds_libs/jtag_uart.cds.lib                 
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/DE0_CV_QSYS.vhd"                                                                                                                           
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/de0_cv_qsys_rst_controller.vhd"                                                                                                            
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/de0_cv_qsys_rst_controller_001.vhd"                                                                                                        
fi
